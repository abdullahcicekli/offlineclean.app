  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        title: '分析与测量',
        content:
          '我们使用 Meta SDK 收集匿名使用分析，以改善应用体验并扩展我们的服务。这些数据不包含您的个人信息或照片。我们只记录应用使用事件。',
        items: [
          { label: '注册完成', text: '当引导流程完成时' },
          { label: '试用开始', text: '当免费试用期开始时' },
          { label: '购买', text: '订阅购买事件' },
          { label: '内容查看', text: '当付费墙页面显示时' },
          { label: '结账开始', text: '当点击购买按钮时' },
          { label: '照片删除', text: '已删除照片数量（非内容）' },
          { label: '清理完成', text: '当清理会话结束时' },
          { label: '竞技场完成', text: '当竞技场挑战完成时' },
          { label: '分析完成', text: '相似、模糊或截图分析' },
        ],
      },
      {
        title: '第三方服务',
