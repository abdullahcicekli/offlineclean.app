  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        title: '분석 및 측정',
        content:
          '앱 경험 개선과 서비스 확장을 위해 Meta SDK를 사용하여 익명의 사용 분석을 수집합니다. 이 데이터에는 개인 정보나 사진이 포함되지 않습니다. 앱 사용 이벤트만 기록합니다.',
        items: [
          { label: '등록 완료', text: '온보딩 프로세스 완료 시' },
          { label: '체험 시작', text: '무료 체험 기간 시작 시' },
          { label: '구매', text: '구독 구매 이벤트' },
          { label: '콘텐츠 조회', text: '페이월 화면 표시 시' },
          { label: '결제 시작', text: '구매 버튼 탭 시' },
          { label: '사진 삭제', text: '삭제된 사진 수 (콘텐츠 아님)' },
          { label: '정리 완료', text: '정리 세션 완료 시' },
          { label: '아레나 완료', text: '아레나 챌린지 완료 시' },
          { label: '분석 완료', text: '유사, 흐림 또는 스크린샷 분석' },
        ],
      },
      {
        title: '타사 서비스',
