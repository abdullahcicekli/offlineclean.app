...
export const esES: Translation = {
  ...
  hero: {
    ...
    subtitle:
      'OfflineClean te ayuda a organizar y liberar espacio de almacenamiento en tu iPhone. Desliza a la derecha para conservar, a la izquierda para eliminar. 100% privado - todo el procesamiento ocurre en tu dispositivo.',
    cta: 'Descargar Gratis',
    statsItems: [
      { text: 'Desliza para Decidir' },
      { text: 'Libera Espacio' },
      { text: '100% Privado' },
      { text: 'Sin Subida a la Nube' },
    ],
  },
    ...
    items: [
      {
        ...
        description:
          'Interfaz simple e intuitiva. Desliza a la derecha para conservar, desliza a la izquierda para eliminar. Toma decisiones en segundos.',
      },
      {
        title: '100% Privado',
        description:
      ...
      },
      {
        ...
        description:
          '¿Cometiste un error? No hay problema. Deshaz tu última decisión o reinicia todo el progreso en cualquier momento.',
      },
      {
        title: 'Eliminación Segura',
        description:
          'Las fotos eliminadas van a la carpeta Eliminadas Recientemente. Tienes 30 días para recuperarlas si es necesario.',
      },
      {
      ...
      {
        title: 'Soporte de Vídeo',
        description:
          'No solo fotos - limpia también tus vídeos con la misma interfaz intuitiva de deslizamiento.',
      },
      {
        title: 'Seguimiento de Progreso',
        description:
          'Ve cuántas fotos has revisado, conservado y marcado para eliminar en tiempo real.',
      },
    ],
  },
  ...
  whyOfflineClean: {
    ...
    reasons: [
      ...
      },
      {
        ...
        description:
          'Empieza a usar inmediatamente sin crear una cuenta. Sin correo electrónico, sin contraseña, sin complicaciones.',
      },
      {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Desliza a la derecha para conservar las fotos que amas. Desliza a la izquierda para marcar fotos para eliminar.',
      },
      {
        title: 'Revisa tus Decisiones',
        description:
          'Comprueba tus fotos conservadas y marcadas. Mueve elementos entre listas si cambias de opinión.',
      },
      {
        title: 'Confirma y Libera Espacio',
        description:
          'Toca finalizar para mover las fotos marcadas a Eliminadas Recientemente. ¡Disfruta de tu almacenamiento liberado!',
      },
    ],
  },
  ...
  pricing: {
    ...
    plans: {
      ...
      yearly: {
        ...
        price: '$29.99',
        period: '/año',
        description: 'Mejor valor para usuarios regulares',
        badge: 'Ahorra 80%',
        perWeek: '~ $0.58/semana',
        features: [
  ...
  faq: {
    ...
    items: [
      {
        question: '¿Están mis datos seguros con OfflineClean?',
        answer:
      ...
      {
        question: '¿Qué pasa con las fotos eliminadas?',
        answer:
          'Las fotos marcadas para eliminar se mueven al álbum Eliminadas Recientemente en tu app de Fotos. Tienes 30 días para recuperarlas antes de que se eliminen permanentemente.',
      },
      {
      ...
      },
      {
        ...
        answer:
          '¡Sí! Puedes deshacer tu última decisión en cualquier momento usando el botón deshacer. También puedes reiniciar todo el progreso y empezar de nuevo si es necesario.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Puedes cancelar tu suscripción en cualquier momento a través de la configuración de tu Apple ID. Ve a Ajustes > Tu Nombre > Suscripciones y encuentra OfflineClean.',
      },
      {
        question: '¿Funciona con vídeos?',
        answer:
          '¡Sí! OfflineClean soporta tanto fotos como vídeos. Puedes previsualizar vídeos y decidir con la misma interfaz de deslizamiento.',
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'OfflineClean requiere acceso a tu biblioteca de fotos para funcionar. Este acceso se usa únicamente para mostrar tus fotos dentro de la app y para eliminar las fotos que elijas quitar. Tus fotos nunca salen de tu dispositivo.',
      },
      {
        title: 'Analíticas y Medición',
        content:
          'Utilizamos Meta SDK para recopilar analíticas de uso anónimas para mejorar la experiencia de la app y escalar nuestros servicios. Estos datos no incluyen tu información personal ni tus fotos. Solo registramos eventos de uso de la app.',
        items: [
          { label: 'Registro completado', text: 'Cuando se completa el proceso de incorporación' },
          { label: 'Inicio de prueba', text: 'Cuando comienza el período de prueba gratuito' },
          { label: 'Compra', text: 'Eventos de compra de suscripción' },
          { label: 'Vista de contenido', text: 'Cuando se muestra la pantalla de pago' },
          { label: 'Inicio de pago', text: 'Cuando se pulsa el botón de compra' },
          { label: 'Eliminación de fotos', text: 'Número de fotos eliminadas (no el contenido)' },
          { label: 'Limpieza completada', text: 'Cuando finaliza la sesión de limpieza' },
          { label: 'Arena completada', text: 'Cuando se completa el desafío de arena' },
          { label: 'Análisis completado', text: 'Análisis de fotos similares, borrosas o capturas de pantalla' },
        ],
      },
      {
    ...
    sections: [
      {
        title: 'Uso de la App',
        content:
          'OfflineClean se proporciona tal cual para uso personal. Eres responsable de cualquier foto que elijas eliminar usando la app.',
      },
      {
        title: 'Suscripciones',
        content:
      ...
      },
      {
        ...
        content:
          'OfflineClean no es responsable de ninguna pérdida de datos resultante del uso de la app. Las fotos eliminadas se mueven al álbum Eliminadas Recientemente y pueden recuperarse dentro de 30 días.',
      },
      {
