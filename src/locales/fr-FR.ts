  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        title: 'Analytique',
        content:
          'Nous pouvons collecter des analyses d\'utilisation anonymes pour améliorer l\'expérience de l\'app. Ces données n\'incluent aucune information personnelle ni accès à vos photos.',
      },
      {
